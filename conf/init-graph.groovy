...
// FIXME: Add key properties / indices for nixtract objects

// Define properties we know will exist
exampleKey = mgmt.makePropertyKey('exampleKey').dataType(String.class).make()

// Create indices
mgmt.buildIndex('byExampleKey', Vertex.class).addKey(exampleKey).buildCompositeIndex()
